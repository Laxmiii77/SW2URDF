...
namespace SW2URDF.URDFExport
{
    ...
    public static class ConfigurationSerialization
    {
        ...
        public static void SaveConfigTreeXML(ISldWorks swApp, ModelDoc2 model, LinkNode BaseNode, bool warnUser)
        {
        ...
        private static SolidWorks.Interop.sldworks.Attribute
            CreateSWSaveAttribute(ISldWorks swApp, ModelDoc2 model, string name)
        {
        ...
        private static void SaveDataToModelDoc(ISldWorks swApp, ModelDoc2 model,
            string data)
        {
            int ConfigurationOptions = (int)swInConfigurationOpts_e.swAllConfiguration;
            SolidWorks.Interop.sldworks.Attribute saveExporterAttribute =
